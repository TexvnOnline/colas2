            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        ...
                        <h1 class="text-center"><span class="brand-name"><b>SGC</b></span></h1>
                        ...
                        <form class="text-left mt-5" action="{{ route('login') }}" method="POST">
                            ...
                            <div class="form" >
                                ...
                                <div id="username-field" class="field-wrapper input">
                                    ...
                                    <input id="email" name="email" type="email" class="form-control @error('email') is-invalid @enderror" placeholder="luisfaax@gmail.com" value="{{ old('email') }}" required autocomplete="email" autofocus>
                                    @error('email')
...
<!--
                    ...
                    <p class="terms-conditions text-center">© 2021 All Rights Reserved. <a href="https://www.youtube.com/playlist?list=PLJjetMSzCM-oklVD-W3yVilbEXAbOk2Ns" target="_blank">LUISFAX</a> <br>versión 1.0 </p>
